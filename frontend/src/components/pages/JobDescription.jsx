    ...
    <div className="max-w-7xl mx-auto my-10">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex item-cente gap-2 mt-4">
            ...
            <Badge className={"text-[#365ca8] font-bold"} variant ="ghost">
              24Lpa
            </Badge>
          </div>
        </div>
      ...
      <div className="my-4" >
          ...
          <h1 className="font-bold my-1">Experience:<span className="pl-4 font-normal text-gray-800">3 year</span></h1>
          <h1 className="font-bold my-1">Salary:<span className="pl-4 font-normal text-gray-800">12LPA</span></h1>
          <h1 className="font-bold my-1">Total Aplicants:<span className="pl-4 font-normal text-gray-800">5</span></h1>
